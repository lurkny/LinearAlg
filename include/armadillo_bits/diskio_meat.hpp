...
diskio::save_csv_ascii(const SpMat< std::complex<T> >& x, std::ostream& f)
  ...
  arma_debug_warn("saving complex sparse matrices as csv_ascii not yet implemented");
...
diskio::load_csv_ascii(SpMat< std::complex<T> >& x, std::istream& f, std::string& err_msg)
  ...
  arma_debug_warn("loading complex sparse matrices as csv_ascii not yet implemented");
