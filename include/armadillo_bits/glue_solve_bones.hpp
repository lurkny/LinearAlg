...
namespace solve_opts
  ...
  static constexpr uword flag_no_warnings  = uword(1u << 11);
  ...
  struct opts_no_warnings  : public opts { inline opts_no_warnings()  : opts(flag_no_warnings ) {} };
  ...
  static const opts_no_warnings  no_warnings;
  }
